...
namespace FSSA.Migrations
{
    ...
    [Migration("20250517184344_AdjustingRequiredVariables")]
    partial class AdjustingRequiredVariables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChecklistDepartment", b =>
                {
                    b.Property<int>("ChecklistsChecklistId")
                        .HasColumnType("int");

                    b.Property<int>("DepartmentsDepartmentId")
                        .HasColumnType("int");

                    b.HasKey("ChecklistsChecklistId", "DepartmentsDepartmentId");

                    b.HasIndex("DepartmentsDepartmentId");

                    b.ToTable("ChecklistDepartment");
                });
            ...
            modelBuilder.Entity("FSSA.Models.Checklist", b =>
                {
                    ...
                    b.Property<string>("FrequencyCount")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ChecklistDepartment", b =>
                {
                    b.HasOne("FSSA.Models.Checklist", null)
                        .WithMany()
                        .HasForeignKey("ChecklistsChecklistId")
